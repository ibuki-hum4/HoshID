export const OIDC_ALLOWED_SCOPES = ["openid", "profile", "email", "offline_access"] as const;
...
export const OIDC_ISSUER = process.env.NEXT_PUBLIC_APP_URL ?? "http://localhost:3000";
